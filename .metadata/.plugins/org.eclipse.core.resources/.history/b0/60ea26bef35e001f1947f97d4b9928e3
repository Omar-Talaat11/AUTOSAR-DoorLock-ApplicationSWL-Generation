 ...
 *****************************************************/
extern my_uint8 Rte_IRead_DoorLock_indication_SWC_DoorLock_indication_RP_SR_DoorState_DoorState (void);
#ifndef IN_RTE_C
 ...
 *****************************************************/
extern Std_ReturnType Rte_Call_DoorLock_indication_SWC_RP_CS_Led_Switch_Led_Switch (my_uint8 LedState);
#ifndef IN_RTE_C
...
typedef Std_ReturnType (*FunctionPtr_DoorLock_indication_SWC_RP_CS_Led_Switch_Led_Switch)(my_uint8 LedState);
